...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //29.649096,-82.343757
        knownLocations.add(new KnownLocation(0,0,Location0.class));
        knownLocations.add(new KnownLocation(29.649096,-82.343757, Location1.class));         //REALLY IMPORTANT, the class is what activity will open
        knownLocations.add(new KnownLocation(5,5, Location15.class));
        knownLocations.add(new KnownLocation( 29.649769,-82.348559, Location2.class));
        knownLocations.add(new KnownLocation(15,15, Location25.class));
        knownLocations.add(new KnownLocation(29.647825,-82.340420, Location3.class));
        knownLocations.add(new KnownLocation(25,25, Location35.class));
        knownLocations.add(new KnownLocation( 29.651470,-82.342913, Location4.class));
        knownLocations.add(new KnownLocation(35,35, Location45.class));
        knownLocations.add(new KnownLocation(29.646090,-82.347730, Location5.class));
        ...
        knownLocations.add(new KnownLocation(42,42, Location75.class));

        //first clue message needs to be its own location as well
    ...
    public void onLocationChanged(Location location) {
        ...
        for(int i=0;i<knownLocations.size();i++){
            ...
            if(loc.isCloseTo(location.getLongitude(),location.getLatitude(),100)){
                ...
                //3.5
                else if(i == 6 && firstLocVisited && secondLocVisited && thirdLocVisited) {
                    loc.show(this,getBaseContext());
                }
                ...
                //4.5
                else if(i == 8 && firstLocVisited && secondLocVisited && thirdLocVisited && fourthLocVisited) {
                    loc.show(this,getBaseContext());
                }
                ...
                //5.5
                else if(i == 10 && firstLocVisited && secondLocVisited && thirdLocVisited && fourthLocVisited && fifthLocVisited) {
                    loc.show(this,getBaseContext());
                }
                ...
                //6.5
                else if(i == 12 && firstLocVisited && secondLocVisited && thirdLocVisited && fourthLocVisited && fifthLocVisited && sixthLocVisited) {
                    loc.show(this, getBaseContext());
                }
                else if(i == 13){
                    loc.show(this,getBaseContext());
                ...
                //what happens if you go to ones in the wrong order
    ...
    public void onNextClicked(View view){
        Intent i = new Intent(getBaseContext(), clue0.class);
        startActivity(i);
    }
}
